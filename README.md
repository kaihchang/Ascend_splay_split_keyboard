...
I wanted a board with both MX and Choc switches, creating a natural elevation when used without wrist rests. One of the reasons I start using split ergos is to save desk space, so I'd like my board to be wireless (utilizing ZMK) and not rely on extra supports like wrist rests.
...
Honestly not super satisfied with the splays and extra pinky columns. Maybe I can make the whole thing a bit smaller with spreads.
